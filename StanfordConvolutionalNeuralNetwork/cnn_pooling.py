...
def pooling(pool_dim, convolve_feat):
	...
	Returns:
	pooled_features - matrix of pooled features (100, m, 2, 2)
	'''
	...
	pooled_features = np.zeros((num_features, m, np.floor(convolved_dim / pool_dim), np.floor(convolved_dim / pool_dim))) # (100, m, 2, 2)
