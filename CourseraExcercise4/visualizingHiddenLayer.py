...
theta = np.genfromtxt("outputs/finalThetasOrdered5000.out")
...
# Plot the results
plt.imshow(total_images, cmap = 'binary', interpolation = 'none')
plt.show()
...
# Plot the results
plt.imshow(image2[0], cmap = 'binary', interpolation = 'none')
plt.show()
...
plt.imshow(combined_images, cmap = 'binary', interpolation = 'none')
plt.show()
...
plt.imshow(image5[0], cmap = 'binary', interpolation = 'none')
plt.show()
