...
gsCV = GridSearchCV(log_reg, param_grid = {'C': [100000.0],
						'tol': [0.000001]},
...
'''
avg_pred = np.zeros((594, 99))
for i in range(594):
	avg_pred[i] = np.mean(y_pred[i * 10 : i * 10 + 10], axis = 0)
...
y_pred = rand_forest.predict_proba(x_test)
'''
